            ...
            <AnimatePresence>
              {cartData.map((item, index) => (
                <motion.div
                  ...
                  transition={{ duration: 0.3 }}
                  exit={{ opacity: 0, y: -20 }}
                  className="flex flex-col sm:flex-row items-center bg-white rounded-2xl shadow-md p-5 hover:shadow-xl transition-all duration-200 border border-r-gray-100"
                >
                  ...
                  <button
                    className="sm:ml4 mt-3 sm:mt-0 text-red-500 hover:text-red-700 transition-all"
