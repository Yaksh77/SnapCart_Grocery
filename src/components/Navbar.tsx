    ...
    ? createPortal(
        <AnimatePresence>
          ...
          >
            ...
            <div className="flex items-start gap-3 p-3 mt-3 rounded-xl bg-white/10 hover:bg-white/15 transition-all shadow-inner">
              ...
              <div>
                ...
                <p className="text-xs capitalize text-green-200 tracking-wide">
                  {user.role}
                </p>
              </div>
            </div>
            <div className="flex flex-col gap-3 font-medium mt-6">
              <Link
                ...
                className="flex items-center gap-2 bg-white/10 hover:bg-white/15 transition-all shadow-inner text-white font-semibold px-4 py-2 rounded-full "
              >
            ...
            <div
              className="flex items-center gap-3 text-red-300 font-semibold mt-auto hover:bg-red-500/20 p-3 rounded-lg translate-all"
