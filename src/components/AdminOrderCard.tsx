...
function AdminOrderCard({ order }: { order: IOrder }) {
  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
        <div className="space-y-1">
          <p className="text-lg font-bold flex items-center gap-2 text-green-700">
            <Package size={20} />
            Order #{order._id?.toString().slice(0, 6)}
          </p>
          <span
          ...
          <p className="flex items-center gap-2 font-semibold mt-3 text-gray-700">
        ...
        <div className="flex flex-col items-start md:items-end gap-2">
          ...
          <select
            className="border border-gray-300 rounded-lg px-3 text-sm shadow-sm hover:border-green-400 transition focus:ring-2 focus:ring-green-500 outline-none"
            onChange={(e) =>
              handleStatus(order._id?.toString()!, e.target.value)
            }
            value={status}
          >
      ...
      <div className="border-t border-gray-200 mt-3 pt-3 w-full">
        <button
      ...
      <div className="w-full border-t pt-3 mt-3 flex justify-between items-center text-sm font-semibold text-gray-800">
